    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			while(rs.next())
			{
				...
				sb.append("<a href='updateHealth.jsp?id="+id+"'><button name='btn_update' type='button' class='btn_update'>编辑</button></a>");
				sb.append("&nbsp;");
				sb.append("<a href='../DeleteHelServlet?id="+id+"'><button name='btn_delete' type='button' class='btn_delete'>删除</button></a>");
			...
			sb.append("合计");
			sb.append("</span></div></td><td height='20' bgcolor='#FFFFFF'><div align='center'><span class='STYLE2'>");
			sb.append("优秀："+String.valueOf(sumInfo1[0])+"个");
			sb.append("</span></div></td><td height='20' bgcolor='#FFFFFF'><div align='center'><span class='STYLE2'>");
			sb.append("良好："+String.valueOf(sumInfo1[1])+"个");
			sb.append("</span></div></td><td height='20' bgcolor='#FFFFFF'><div align='center'><span class='STYLE2'>");
			sb.append("合格："+String.valueOf(sumInfo1[2])+"个"); 
			sb.append("</span></div></td><td height='20' bgcolor='#FFFFFF'><div align='center'><span class='STYLE2'>");
			sb.append("不合格："+String.valueOf(sumInfo1[3])+"个");
			sb.append("</span></div></td><td height='20' bgcolor='#FFFFFF'><div align='center'><span class='STYLE2'>");
			sb.append("");
			sb.append("</span></div></td><td height='20' bgcolor='#FFFFFF'><div align='center'><span class='STYLE2'>");
			sb.append("");
