...
/**
 * Servlet implementation class QueryallHelServlet
 */
@WebServlet("/QueryallHelServlet")
public class QueryallHelServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryallHelServlet() {
        super();
