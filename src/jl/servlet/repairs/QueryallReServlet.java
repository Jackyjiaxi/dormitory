...
/**
 * Servlet implementation class QueryallReServlet
 */
@WebServlet("/QueryallReServlet")
public class QueryallReServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryallReServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultSet rs=DaoFactory.getRepairsInstance().queryAll();
		...
		try {
			while(rs.next())
			{
				...
				sb.append("<a target='_blank' href='../QueryallRmServlet?id="+id+"'><button name='btn_update' type='button' class='btn_update'> ‹¿Ì</button></a>");
				sb.append("&nbsp;");
