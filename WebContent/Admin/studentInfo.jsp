...
<div id="container">
    ...
    <div id=main>
    	...
    	<div id="content">
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			<tr><td height="90" background="../images/tab_05.gif">
  				<table width="100%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="12" height="90"><img src="../images/tab_03.gif" width="12" height="90" /></td>
        			<td>
        				<form name="query" method="post" action="../QueryStuServlet">
							<div id="query">
								条件：
										<label>区：</label>
										...
										<label>学号：</label>	
											<input name="stuId" type="text" value="请输入数值">&nbsp;
										<label>&nbsp;&nbsp;&nbsp;学院：</label>	
											<input name="stuSchool" type="text" value="请输入">&nbsp;&nbsp;&nbsp;
										<label>专业：</label>	
											<input name="stuMajor" type="text" value="请输入">&nbsp;&nbsp;&nbsp;
										<label>姓名：</label>	
											<input name="stuName" type="text" value="请输入">&nbsp;&nbsp;&nbsp;
										<label>性别：</label>
											<select id="selStu" name="stuGender">
											<option>请选择</option>
								...
								<a href="../QueryallStuServlet"><button name="queryAll" type="button" class="btn_queryAll">查询所有宿舍信息</button></a>
							</div>
						</form>
        			</td>
        			<td width="16"><img src="../images/tab_07.gif" width="16" height="90" /></td>
      			</tr>
    			</table>
    		</td></tr>
      			...
      			<tr>
        			...
        			<form name="tab" method="post" action="#">
        				<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          				<tr>
            				<th width="5%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">学号</span></div></th>
            				<th width="5%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">姓名</span></div></th>
            				<th width="4%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">性别</span></div></th>
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">籍贯</span></div></th>
            				<th width="9%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">出生日期</span></div></th>
            				<th width="5%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">学院</span></div></th>
            				<th width="9%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">专业</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">入学日期</span></div></th>
            				<th width="5%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">学制</span></div></th>
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">学历</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">联系电话</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">备注</span></div></th>
            				<th width="7%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍区栋</span></div></th>
            				<th width="5%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍号</span></div></th>
          				</tr>
          				<!-- 此处增添记录 -->
