...
<div id="container">
    ...
    <div id=main>
    	...
    	<div id="content">
    		<form id="studentLeaveForm" name="studentLeaveForm" method="post" action="../DeleteStuInfoServlet">
    			<table align="center" class="studentLeaveTab" border="0" cellspacing="0" cellpadding="11px">
    			<tr>
    		...
    		<hr><hr>
    		<form id="studentLeaveForm" name="studentLeaveForm" method="post" action="../DeleteStuServlet">
    		<table align="center" class="studentLeaveTab" border="0" cellspacing="0" cellpadding="11px">
    			<tr>
    			...
    			<tr>
    				<td><label>宿舍区栋：</label><input name="section" type="text" value=<%=session.getAttribute("do_section") %> readonly="readonly"></td>
    				<td><label>宿舍号：</label><input name="number" type="text" value=<%=session.getAttribute("do_number") %> readonly="readonly"></td>
    			</tr>
    			<tr>
    				<td colspan="2" align="center">
    					<input name="submit" type="submit" value="确认离校" onclick="javascript:alert('离校操作成功！')"> 
