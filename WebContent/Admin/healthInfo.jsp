    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			<tr><td height="60" background="../images/tab_05.gif">
      			...
      			<tr>
        			...
        			<td>
        				<form name="query" method="post" action="../QueryHelServlet">
							<div id="query">
										<label>区：</label>
								...
								<a href="../QueryallHelServlet"><button name="queryAll" type="button" class="btn_queryAll">查询所有宿舍信息</button></a>
							</div>
						</form>
        			</td>
      			...
      			<tr>
        			...
        			<form name="tab" method="post" action="#">
        				<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          				<tr>
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">检查ID</span></div></th>
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍区栋</span></div></th>
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍号</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">检查人</span></div></th>
            				<th width="12%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">检查结果</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">检查日期</span></div></th>
            				<th width="26%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">备注</span></div></th>
            				<th width="18%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE4">操作</span></div></th>
          				</tr>
          				<!-- 此处增添记录 -->
