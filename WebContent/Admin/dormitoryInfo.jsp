    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			<tr><td height="60" background="../images/tab_05.gif">
      			...
      			<tr>
        			...
        			<td>
        				<form name="query" method="post" action="../QueryDorServlet">
							<div id="query">
								精确查找：
										<label>区：</label>
										...
										<label>宿舍床位数：</label>	
											<input id="bed" name="dorBed" type="text" value="请输入数值">&nbsp;&nbsp;&nbsp;
										<label>宿舍有无空床位：</label>
											<select id="selDor" name="dorEmptybeds">
											<option>请选择</option>
											<option value="0">无</option>
											<option value=">0">有</option>
						                    </select>&nbsp;
								<input name="submit" type="submit" value="查询">&nbsp;
								<a href="../QueryallDorServlet"><button name="queryAll" type="button" class="btn_queryAll">查询所有宿舍信息</button></a>
							</div>
						</form>
        			</td>
      			...
      			<tr>
        			...
        			<form name="tab" method="post" action="#">
        				<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          				<tr>
            				<th width="6%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍ID</span></div></th>
            				...
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍床位数</span></div></th>
            				<th width="12%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍空闲床位数</span></div></th>
            				<th width="8%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍类型</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍水表底数</span></div></th>
            				<th width="10%" height="22" background="../images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE2">宿舍电表底数</span></div></th>
