...
String sql="SELECT * FROM administrator WHERE ad_username='"+name+"';";
System.out.println(sql);
ResultSet rs=DbUtil.executeQuery(sql);
rs.next();
session.setAttribute("name",request.getParameter("name"));
%>
<form name=updateinfo method="post" action="../UpdateServlet">
<table align="center"  class="updateuserinfo" border="0" cellspacing="0" cellpadding="11px">
<tr>
	<td>【原始信息】</td>
	<td>【将要更改的信息】</td>
</tr>
<tr><td>用户名：<%=name %></td></tr>
<tr>
	<td>姓名：<%=rs.getString("ad_name") %></td>
	<td><input id="name" name="updateName" type="text" value=<%=rs.getString("ad_name") %>></td>
</tr>
<tr>
	<td>联系方式：<%=rs.getString("ad_phone") %></td>
	<td><input id="phone" name="updatePhone" type="text" value=<%=rs.getString("ad_phone") %>></td>
</tr>
<tr>
