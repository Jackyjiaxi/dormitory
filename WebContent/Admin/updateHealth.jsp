...
String sql="SELECT * FROM health WHERE he_id="+id;
System.out.println(sql);
ResultSet rs=DbUtil.executeQuery(sql);
rs.next();
session.setAttribute("id",id);
%>
<form name=updateinfo method="post" action="../UpdateHelServlet">
<table align="center"  class="updatehelinfo" border="0" cellspacing="0" cellpadding="11px">
<tr>
	<td>【原始信息】</td>
	<td>【将要更改的信息】</td>
</tr>
...
<tr>
	<td>检查人：<%=rs.getString("he_person") %></td>
	<td><input name="upPerson" type="text" value=<%=rs.getString("he_person") %>></td>
</tr>
<tr>
	<td>检查结果：<%=rs.getString("he_result") %></td>
	<td>
		<select name="upResult">
			<option value="优秀" <%if(rs.getString("he_result").equals("优秀")) out.print("selected='selected'"); %>>优秀</option>
			<option value="良好" <%if(rs.getString("he_result").equals("良好")) out.print("selected='selected'"); %>>良好</option>
			<option value="合格" <%if(rs.getString("he_result").equals("合格")) out.print("selected='selected'"); %>>合格</option>
			<option value="不合格" <%if(rs.getString("he_result").equals("不合格")) out.print("selected='selected'"); %>>不合格</option>
		</select>
	</td>
</tr>
<tr>
	<td>检查日期：<%=rs.getString("he_date") %></td>
	<td><input name="upDate" type="date" value=<%=rs.getString("he_date") %>></td>
</tr>
<tr>
	<td>备注：<%=rs.getString("he_remark") %></td>
	<td><input name="upRemark" type="text" value=<%=rs.getString("he_remark") %>></td>
</tr>
<tr>
